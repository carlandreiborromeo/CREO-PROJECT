        ...
        <div className="w-full max-w-[1920px] mx-auto">
          ...
          <div className="bg-zinc-700/90 backdrop-blur-sm p-6 rounded-xl shadow-2xl mb-8">
            <div className="flex gap-4">
              ...
              >
                📚 Generated Files History ({generatedFiles.length})
              </button>
            </div>
          </div>
                    ...
                    <div className="flex items-center justify-center space-x-6 mb-4">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-xl text-white mb-2">
                          ...
                          <span className="text-white font-bold ml-3 text-2xl bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
                            {topper.over_all || "N/A"}
                          </span>
                        </div>
                          ...
                          >
                            ...
                            <td className="border border-zinc-600 p-3 bg-zinc-800/80">
                              <input
                                ...
                                className="w-full p-2 bg-zinc-700 border border-zinc-500 rounded-lg text-white text-center focus:border-[#6a0dad] focus:outline-none focus:ring-2 focus:ring-[#6a0dad]/20"
                                min="0"
                                max="100"
                                placeholder="0"
                              />
          ...
          {activeTab === "history" && (
            <div className="flex gap-8">
              {/* Files Sidebar */}
              <div className="w-96 bg-zinc-700/90 backdrop-blur-sm p-6 rounded-xl shadow-2xl">
                <div className="mb-6">
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 rounded-xl transition-all duration-300 font-bold text-white shadow-lg"
                ...
                <div className="space-y-3 max-h-[600px] overflow-y-auto">
                  {generatedFiles.length === 0 ? (
                    ...
                    generatedFiles.map((file) => (
                      <div
                        key={file.id}
                        className={`p-4 rounded-xl border cursor-pointer transition-all duration-300 shadow-lg hover:shadow-xl ${
                          selectedFile?.id === file.id
                            ? "bg-gradient-to-r from-purple-600 to-purple-700 border-purple-400 transform scale-105"
                      ...
                      >
                        <div className="font-bold text-lg text-white truncate mb-2">
                          {file.batch}
                        </div>
              ...
              <div className="flex-1">
                {!selectedFile ? (
                  ...
                  <>
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div>
                          ...
                          <div className="flex items-center gap-6 text-lg text-gray-300">
                            ...
                            <span>
                              🎓 {selectedFileStudents.length} students
                            </span>
                            {selectedFile.file_size && (
                              <span>
                                💾 {Math.round(selectedFile.file_size / 1024)}{" "}
                                KB
                              </span>
                            )}
                          </div>
                          ...
                          {!isEditingHistory ? (
                            <>
                              <button
                                ...
                                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl transition-all duration-300 font-bold text-white shadow-lg"
                              >
                                ✏️ Edit
                              </button>
                              <button
                                ...
                                className="px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 rounded-xl transition-all duration-300 font-bold text-white shadow-lg disabled:opacity-50"
                              >
                                {isDownloading
                                  ? "⏳ Downloading..."
                                  : "⬇️ Download"}
                              ...
                              <button
                                ...
                                className="px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 rounded-xl transition-all duration-300 font-bold text-white shadow-lg"
                              >
                                🗑️ Delete
                              </button>
                            </>
                            ...
                            <>
                              <button
                                onClick={updateFile}
                                disabled={isUpdating}
                                className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 rounded-xl transition-all duration-300 font-bold text-white shadow-lg disabled:opacity-50"
                              >
                                {isUpdating
                                  ? "⏳ Saving..."
                                  : "💾 Save Changes"}
                              ...
                              <button
                                ...
                                className="px-6 py-3 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 rounded-xl transition-all duration-300 font-bold text-white shadow-lg"
                              >
                                ❌ Cancel
                              </button>
                            </>
                    ...
                    {isEditingHistory ? (
                      <div className="bg-zinc-700/90 backdrop-blur-sm p-8 rounded-xl shadow-2xl">
                        ...
                        {filteredHistoryStudents.length === 0 ? (
                          <div className="text-center text-gray-400 py-12">
                            ...
                            <div className="text-xl">
                              No students found in {historyActiveDept}{" "}
                              department
                            </div>
                          </div>
                        ) : (
                                    ...
                                    >
                                      ...
                                      <td className="border border-zinc-600 p-3 bg-zinc-800/80">
                                        <input
                                          ...
                                          className="w-full p-2 bg-zinc-700 border border-zinc-500 rounded-lg text-white text-center focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                                          min="0"
                                          max="100"
                                          step="0.1"
                                          placeholder="0"
                        ...
                        {selectedFileStudents.length === 0 ? (
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {selectedFileStudents.map((student, index) => (
                              <div
                                key={student.id || index}
                                className="bg-zinc-600/80 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-zinc-500"
                              >
